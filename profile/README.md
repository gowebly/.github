...
Project originally developed in 2023 by [Vic Shóstak][vic_shostak_url] and the [True Web Artisans][true_web_artisans_url] team (_who still works on it today_).

<a href="https://github.com/gowebly/gowebly" target="_blank"><img width="99%" alt="gowebly logo" src="https://raw.githubusercontent.com/gowebly/.github/main/images/gowebly-project-banner.svg"></a>
...
> - Frontend development (creating a new templates with htmx, hyperscript, and CSS frameworks);
...
- [gowebly][gowebly_url]: A next-generation CLI tool for building amazing web apps in Go using htmx & hyperscript
- [helpers][gowebly_helpers_url]: A most useful helpers for build the best Go web applications with the Gowebly CLI
- [docs][gowebly_docs_url]: The official documentation of the Gowebly CLI
...
[gowebly_docs_url]: https://github.com/gowebly/docs
